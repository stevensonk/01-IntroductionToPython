...
homework = rg.SimpleTurtle('turtle')
homework.pen = rg.Pen('blue',1)

homework.left(90)
homework.forward(200)
homework.pen_up()
homework.go_to(rg.Point(100,-40))
homework.pen_down()
homework.pen = rg.Pen('green',10)
homework.backward(150)
